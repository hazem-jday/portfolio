    ...
    <section className="fixed inset-0 flex items-center justify-center bg-opacity-70 bg-black z-40 over">
      <div className="relative bg-white/20 p-2 rounded-lg w-[70%] sm:w-[60%] max-w-[800px] modalCard max-h-[80vh] flex flex-col overflow-y-auto lg:text-lg lg:w-[90%]">
            ...
            <li>
              ...
              {SelectedProject.technologies.map((tech, i) => (
                <div className="inline-flex" key={i}>
                  <span className="whitespace-nowrap bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-blue-900 dark:text-blue-300">{tech}</span>
                  {" "}
                </div>
              ))}
              <span> </span>
        ...
        <button
          ...
          className="fixed bottom-10 right-0 left-0 lg:right-4 cursor-pointer"
        >
